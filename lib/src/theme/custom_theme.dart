...
class CustomTheme extends StatefulWidget {
  ...
  static CustomThemeState of(BuildContext context) {
    return context.findAncestorStateOfType<State<CustomTheme>>();
  }
}
...
class CustomThemeState extends State<CustomTheme> {
  ...
  Future<void> _loadBrightness() async {
    ...
    final bool isDark = await getBrightnessBool();
  ...
  @override
  void didUpdateWidget(CustomTheme oldWidget) {
  ...
  Future<bool> getBrightnessBool() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
